...
function odinokov_ai_admin_menu() {
    ...
    add_submenu_page(
        ...
        'AI Chat — Логи',
        'manage_options',
        'odinokov-ai-chat-logs',
        'odinokov_ai_logs_page'
    );
}
...
function odinokov_ai_register_settings() {
    ...
    register_setting('odinokov_ai_options', 'odinokov_ai_model', ['type' => 'string', 'sanitize_callback' => 'sanitize_text_field', 'default' => 'deepseek-flash']);
                ...
                <tr>
                    ...
                    <td>
                        <select id="odinokov_ai_model" name="odinokov_ai_model">
                            <option value="deepseek-flash" <?php selected(get_option('odinokov_ai_model', 'deepseek-flash'), 'deepseek-flash'); ?>>DeepSeek Flash (V4.1)</option>
                            <option value="deepseek-v4-pro" <?php selected(get_option('odinokov_ai_model', 'deepseek-flash'), 'deepseek-v4-pro'); ?>>DeepSeek V4 Pro</option>
                        </select>
                    </td>
                </tr>
                <tr>
...
function odinokov_ai_logs_page() {
